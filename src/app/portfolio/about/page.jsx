...
const About = () => {
  return (
    <section className="bg-white h-screen dark:bg-gray-950">
      <div className="container mx-auto px-4 py-36 flex justify-center">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-16">
          {/* Profile Section with Semantic Tags */}
          <aside
            className="flex items-center justify-center md:justify-start"
            data-aos="zoom-in-left"
          >
            <div className="bg-white dark:bg-gray-950 rounded-lg shadow-md border border-lime-500 p-20 md:p-8">
              <figure>
                <Image
                ...
                <figcaption className="text-center md:text-left">
                  <h3 className="text-xl md:text-3xl text-gray-800 dark:text-white font-semibold mt-4 md:mt-0">
                    Chandan Jadhav
                  </h3>
                  <p className="text-base md:text-lg text-gray-600 dark:text-white mt-1">
          ...
          <article className="flex flex-col items-center md:items-start">
            <header>
              <h4 className="text-lg md:text-2xl text-gray-800 dark:text-white font-semibold mb-2">
                About Me
              </h4>
            </header>
            <p className="text-sm md:text-lg text-gray-600 dark:text-white">
              A passionate IT professional with over 6 months of internship
